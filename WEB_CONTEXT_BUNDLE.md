...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-596-erd-s-problem-596-036f2f21-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-596"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-596-erd-s-problem-596-036f2f21-v1",
      "problem_contract_sha256": "4152eaabe5ef98a5932be4c0108c330886a45c36d7493ee01fa217d5ce336ca8",
      "problem_id": "problem:um-ep-596-erd-s-problem-596-036f2f21",
      "route_id": "route:um-ep-596-erd-s-problem-596-036f2f21-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-596-erd-s-problem-596-036f2f21-source-fidelity-01",
      "graph_id": "graph:um-ep-596-erd-s-problem-596-036f2f21-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-596-erd-s-problem-596-036f2f21-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-596-erd-s-problem-596-036f2f21-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "For which graphs $G_1,G_2$ is it true that {UL} {LI} for every $n\\geq 1$ there is a graph $H$ without a $G_1$ but if the edges of $H$ are $n$-coloured then there is a monochromatic copy of $G_2$, and yet{/LI} {LI} for every graph $H$ without a $G_1$ there is an $\\aleph_0$-colouring of the edges of $H$ without a monochromatic $G_2$. {/UL}"
          },
          "statement_sha256": "e6a8fba79b141b49d9ae335ae11a9dd782eff003623f22cb7b48755387cb00d4"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-596-erd-s-problem-596-036f2f21-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-596-erd-s-problem-596-036f2f21-root",
      "route_id": "route:um-ep-596-erd-s-problem-596-036f2f21-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-596-ad2e70323914",
        "url": "https://www.unsolvedmath.com/problems/EP-596"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
